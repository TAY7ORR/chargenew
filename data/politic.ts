  ...
  ru: {
    ...
    privacyPolicy: {
      ...
      sections: {
        intro: {
          title: 'Введение',
          content: 'Fast Charge серьезно относится к защите вашей конфиденциальности. Настоящая политика конфиденциальности описывает, какую информацию мы собираем, как ��ы ее используем и какие права у вас есть в отношении ваших персональных данных.',
        },
        dataCollection: {
