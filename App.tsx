...
export const translations: Translations = {
  ru: {
    ...
    webSubtitle: 'Интерактивная карта с точками аренды повербанков',
    ...
    heroSubtitle: 'Аренда повербанков по всему Азербайджану. Быстро, удобно, доступно.',
    ...
    faq1A: 'Наши станции расположены в торговых центрах, кафе, ресторанах и других популярных местах по всему Азербайджану. Используй карту в приложении, чтобы найти ближайшую станцию.',
    ...
    faq4A: 'Первый час — 1.5 AZN, второй час — 1.5 AZN, третий час — 0.5 AZN. Весь день обойдётся всего в 3.5 AZN.',
    faqImportantQ: 'Что делать, если повербанк не работает?',
    faqImportantA: 'Верните его обратно на станцию и обязательно свяжитесь с нами. В данном случае мы вернём вам полную стоимость и окажем помощь.',
    aboutTitle: 'О Fast Charge',
    aboutText1: 'Fast Charge — это инновационная платформа для аренды повербанков в Азербайджане. Мы создали сеть станций по всему городу, чтобы вы всегда оставались на связи.',
    ...
    aboutMissionText: 'Мы стремимся сделать зарядку устройств простой и доступной для всех жителей и гостей Азербайджана. Наша цель — создать самую удобную сеть станций для аренды повербанков.',
    ...
    appText: 'Арендуй повербанк в один клик. Скачай приложение и получи доступ к сети станций Fast Charge по всему Азербайджану.',
    appFeature1: 'Интерактивная карта',
    appFeature1Text: 'Найди ближайшую станцию на карте в реальном времени',
    ...
    contactEmail: 'fastcharge@fastcharge.az',
    contactPhone: '+994 77 225-55-55',
    contactAddress: 'Баку, Нариманов, ул. Юсифа Вазира Чеменземинли, 14',
    ...
    footerAbout: 'Fast Charge — современный сервис аренды повербанков в Азербайджане.',
    ...
    pricingSubtitle: 'Выбери тариф, который подходит тебе. Никаких скрытых платежей!',
    pricing60min: '60 минут',
    pricing120min: '120 минут',
    pricingFullDay: 'Весь день',
    pricingPopular: 'ПОПУЛЯРНО',
    pricingFeature1: 'Быстрая зарядка',
    pricingFeature2: 'Возврат в любой точке',
    pricingFeature3: 'Без залога',
    pricingCTA: 'Поехали',
    pricingNote: '* Цены указаны в азербайджанских манатах (₼). Оплата производится через приложение.',
  },
  en: {
    home: 'Home',
    about: 'About',
    ...
    webSubtitle: 'Interactive map with power bank rental locations',
    ...
    heroSubtitle: 'Power bank rental across Azerbaijan. Fast, convenient, accessible.',
    ...
    faq1A: 'Our stations are located in shopping malls, cafes, restaurants, and other popular places throughout Azerbaijan. Use the map in the app to find the nearest station.',
    ...
    faq4A: 'First hour — 1.5 AZN, second hour — 1.5 AZN, third hour — 0.5 AZN. The whole day costs only 3.5 AZN.',
    faqImportantQ: 'What if the power bank doesn\'t work?',
    faqImportantA: 'Return it back to the station and make sure to contact us. In this case, we will refund you the full amount and provide assistance.',
    aboutTitle: 'About Fast Charge',
    aboutText1: 'Fast Charge is an innovative power bank rental platform in Azerbaijan. We created a network of stations across the country so you stay connected always.',
    ...
    aboutMissionText: 'We strive to make device charging simple and accessible for all residents and visitors of Azerbaijan. Our goal is to create the most convenient power bank rental network.',
    ...
    appTitle: 'Our App',
    appText: 'Rent a power bank with one click. Download the app and get access to Fast Charge stations throughout Azerbaijan.',
    ...
    contactEmail: 'fastcharge@fastcharge.az',
    contactPhone: '+994 77 225-55-55',
    contactAddress: 'Baku, Narimanov district, Yusif Vazir Chamanzaminli str., 14',
    ...
    footerAbout: 'Fast Charge — modern power bank rental service in Azerbaijan.',
    ...
    pricingSubtitle: 'Choose the plan that suits you. No hidden fees!',
    pricing60min: '60 minutes',
    pricing120min: '120 minutes',
    pricingFullDay: 'Full Day',
    pricingPopular: 'POPULAR',
    pricingFeature1: 'Fast charging',
    pricingFeature2: 'Return anywhere',
    pricingFeature3: 'No deposit',
    pricingCTA: 'Let\'s Go',
    pricingNote: '* Prices are in Azerbaijani Manat (₼). Payment is made through the app.',
  },
  az: {
    home: 'Əsas',
    about: 'Haqqımızda',
    ...
    webSubtitle: 'Powerbank icarəsi üçün interaktiv xəritə',
    ...
    heroSubtitle: 'Azərbaycanda hər yerində powerbank icarəsi. Sürətli, rahat, əlçatan.',
    ...
    faq1A: 'Bizim stansiyalar ticarət mərkəzlərində, kafelərdə, restoranlarda və Azərbaycanın digər məşhur yerlərində yerləşir. Ən yaxın stansiyanı tapmaq üçün tətbiqdəki xəritədən istifadə edin.',
    ...
    faq4A: 'İlk saat — 1.5 AZN, ikinci saat — 1.5 AZN, üçüncü saat — 0.5 AZN. Bütün gün cəmi 3.5 AZN.',
    faqImportantQ: 'Powerbank işləmirsə nə etməli?',
    faqImportantA: 'Onu stansiyaya qaytarın və mütləq bizimlə əlaqə saxlayın. Bu halda biz sizə tam məbləği qaytaracağıq və kömək göstərəcəyik.',
    aboutTitle: 'Fast Charge Haqqında',
    aboutText1: 'Fast Charge — Azərbaycanda powerbank icarəsi üzrə innovativ platformadır. Biz şəhərin hər yerində stansiyalar şəbəkəsi yaratdıq ki, siz həmişə əlaqədə olasınız.',
    ...
    aboutMissionText: 'Azerbaycanın bütün sakinləri və qonaqları üçün cihazların şarj edilməsini sadə və əlçatan etməyə çalışırıq. Məqsədimiz ən rahat powerbank icarəsi şəbəkəsini yaratmaqdır.',
    ...
    appText: 'Bir kliklə powerbank icarəyə götür. Tətbiqi yüklə və Azərbaycanın hər yerində Fast Charge stansiyalarına giriş əldə et.',
    ...
    contactEmail: 'fastcharge@fastcharge.az',
    contactPhone: '+994 77 225-55-55',
    contactAddress: 'Bakı şəhəri, Nərimanov rayonu, Yusif Vəzir Çəmənzəminli küçəsi, 14',
    ...
    footerAbout: 'Fast Charge — Azərbaycan müasir powerbank icarəsi xidməti.',
    ...
    // Pricing
    pricingTitle: 'Sadə və Ədalətli Qiymətlər',
    pricingSubtitle: 'Özünə uyğun tarifdə seç. Gizli ödənişlər yoxdur!',
    pricing60min: '60 dəqiqə',
    pricing120min: '120 dəqiqə',
    pricingFullDay: 'Bütün gün',
    pricingPopular: 'POPULYAR',
    pricingFeature1: 'Sürətli şarj',
    pricingFeature2: 'İstənilən yerdə qaytarma',
    pricingFeature3: 'Depozit yoxdur',
    pricingCTA: 'Gedək',
    pricingNote: '* Qiymətlər Azərbaycan manatı (₼) ilə göstərilib. Ödəniş tətbiq vasitəsilə həyata keçirilir.',
  },
};
